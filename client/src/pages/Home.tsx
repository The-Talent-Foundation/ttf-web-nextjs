  ...
  return (
    <ScrollAnimations>
      ...
      <section className="bg-bg-dark py-xxxl pt-[10px] pb-[10px]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[0px] pb-[0px]">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="border-t border-gray-700 pt-lg mt-lg">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-md">
                <Link href="/services/illuminate#solution" className="group flex items-center gap-md p-md rounded-lg hover:bg-gray-800 transition-all duration-300">
                ...
                <Link href="/services/innovate#solution" className="group flex items-center gap-md p-md rounded-lg hover:bg-gray-800 transition-all duration-300">
                ...
                <Link href="/services/elevate#solution" className="group flex items-center gap-md p-md rounded-lg hover:bg-gray-800 transition-all duration-300">
                ...
                <Link href="/services/accelerate#solution" className="group flex items-center gap-md p-md rounded-lg hover:bg-gray-800 transition-all duration-300">
